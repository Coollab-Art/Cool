...
Cool::json_get(json, "WindowBorderHoverPadding", style.WindowBorderHoverPadding);
...
Cool::json_get(json, "ImageBorderSize", style.ImageBorderSize);
Cool::json_get(json, "TabRounding", style.TabRounding);
Cool::json_get(json, "TabBorderSize", style.TabBorderSize);
Cool::json_get(json, "TabCloseButtonMinWidthSelected", style.TabCloseButtonMinWidthSelected);
Cool::json_get(json, "TabCloseButtonMinWidthUnselected", style.TabCloseButtonMinWidthUnselected);
Cool::json_get(json, "TabBarBorderSize", style.TabBarBorderSize);
Cool::json_get(json, "TabBarOverlineSize", style.TabBarOverlineSize);
Cool::json_get(json, "TableAngledHeadersAngle", style.TableAngledHeadersAngle);
Cool::json_get(json, "TableAngledHeadersTextAlign", style.TableAngledHeadersTextAlign);
Cool::json_get(json, "TreeLinesFlags", style.TreeLinesFlags);
Cool::json_get(json, "TreeLinesSize", style.TreeLinesSize);
Cool::json_get(json, "TreeLinesRounding", style.TreeLinesRounding);

...
Cool::json_set(json, "WindowBorderHoverPadding", style.WindowBorderHoverPadding);
...
Cool::json_set(json, "ImageBorderSize", style.ImageBorderSize);
Cool::json_set(json, "TabRounding", style.TabRounding);
Cool::json_set(json, "TabBorderSize", style.TabBorderSize);
Cool::json_set(json, "TabCloseButtonMinWidthSelected", style.TabCloseButtonMinWidthSelected);
Cool::json_set(json, "TabCloseButtonMinWidthUnselected", style.TabCloseButtonMinWidthUnselected);
Cool::json_set(json, "TabBarBorderSize", style.TabBarBorderSize);
Cool::json_set(json, "TabBarOverlineSize", style.TabBarOverlineSize);
Cool::json_set(json, "TableAngledHeadersAngle", style.TableAngledHeadersAngle);
Cool::json_set(json, "TableAngledHeadersTextAlign", style.TableAngledHeadersTextAlign);
Cool::json_set(json, "TreeLinesFlags", style.TreeLinesFlags);
Cool::json_set(json, "TreeLinesSize", style.TreeLinesSize);
Cool::json_set(json, "TreeLinesRounding", style.TreeLinesRounding);

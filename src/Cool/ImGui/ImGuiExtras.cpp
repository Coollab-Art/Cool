...
bool BeginMenu(const char* label, const char* icon, bool enabled, float arrow_offset_y)
{
    ...
    const bool menuset_is_open = true;
    if (menuset_is_open)
    ...
    else
    {
        ...
        else if (pressed) // First click to open, then hover to open others
        {
            want_open = true;
        }
